...
1. Set up MFA for your root user, turn off all root user API keys.
1. Set up Billing Alerts for anything over a few dollars.
1. Configure the AWS CLI for your user using API credentials.
1. Checkpoint: You can use the AWS CLI to interrogate information about your AWS account.
...
2. Answer the following for each of the main architectures you built:
   1. Roughly how much would this have costed for a month?
   2. How would I scale this architecture and how would my costs change?
...
Source: https://www.reddit.com/r/sysadmin/comments/8inzn5/so_you_want_to_learn_aws_aka_how_do_i_learn_to_be/ by /u/SpectralCoding